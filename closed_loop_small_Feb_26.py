...
for ensemble_index in range(num_ensembles):
    ...
    torch.save(error1_tensor,'/mnt/qb/work/goswami/ranganathabr08/common_directory/Mar_results/small_closed/errors/lstm_'+str(ensemble_index)+'.pt')
    torch.save(model1, '/mnt/qb/work/goswami/ranganathabr08/common_directory/Mar_results/small_closed/models/lstm'+str(ensemble_index)+'.pt')
    ...
    torch.save(error2_tensor,'/mnt/qb/work/goswami/ranganathabr08/common_directory/Mar_results/small_closed/errors/fc_'+str(ensemble_index)+'.pt')
    torch.save(model2, '/mnt/qb/work/goswami/ranganathabr08/common_directory/Mar_results/small_closed/models/fc_'+str(ensemble_index)+'.pt')
    trend1 = torch.mean(ls_tensor1, axis = 0)
    torch.save(trend1, '/mnt/qb/work/goswami/ranganathabr08/common_directory/Mar_results/small_closed/error_trend/lstm_'+str(ensemble_index)+'.pt')
    trend2 = torch.mean(ls_tensor2, axis = 0)
    torch.save(trend2, '/mnt/qb/work/goswami/ranganathabr08/common_directory/Mar_results/small_closed/error_trend/fc_'+str(ensemble_index)+'.pt')
