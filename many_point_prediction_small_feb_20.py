...
for ensemble_index in range(num_ensembles):
    ...
    torch.save(error1_tensor,'/mnt/qb/work/goswami/ranganathabr08/common_directory/Feb_results/Feb_results_20/many_points_errors_lstm_small_model_'+str(ensemble_index)+'.pt')
    torch.save(model1, '/mnt/qb/work/goswami/ranganathabr08/common_directory/Feb_results/Feb_results_20/many_points_lstm_small_model_'+str(ensemble_index)+'.pt')
    ...
    torch.save(error2_tensor,'/mnt/qb/work/goswami/ranganathabr08/common_directory/Feb_results/Feb_results_20/many_points_errors_fc_small_model_'+str(ensemble_index)+'.pt')
    torch.save(model2, '/mnt/qb/work/goswami/ranganathabr08/common_directory/Feb_results/Feb_results_20/many_points_fc_small_model_'+str(ensemble_index)+'.pt')
    ...
    torch.save(ls_full_tensor, '/mnt/qb/work/goswami/ranganathabr08/common_directory/Feb_results/Feb_results_20/many_points_small_close_open_error_lstm'+str(ensemble_index)+'.pt')
    ...
    ls_close_tensor = torch.Tensor(ls_close).view(-1,1)
    ls_full_tensor = torch.concat((ls_tensor, ls_close_tensor),axis = 1)
    torch.save(ls_full_tensor, '/mnt/qb/work/goswami/ranganathabr08/common_directory/Feb_results/Feb_results_20/many_points_small_close_open_error_fc'+str(ensemble_index)+'.pt')
