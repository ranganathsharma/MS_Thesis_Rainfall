...
for year_index in range(1979,2020):
	file_address = '/mnt/qb/work/goswami/ranganathabr08/cluster_files/cluster_files/clusters_new'+str(year_index)+'.csv'
...
with open('/mnt/qb/work/goswami/ranganathabr08/common_directory/Mar_results/powerlaw_time_all.txt',form) as f:
...
plt.xlabel('duration')
plt.ylabel('p(d)')
plt.savefig('/mnt/qb/work/goswami/ranganathabr08/common_directory/Mar_results/powerlaw_time_all.png')
