...
for ensemble_index in range(num_ensembles):
    ...
    torch.save(ls_full_tensor, '/mnt/qb/work/goswami/ranganathabr08/common_directory/Feb_results/close_open_error_lstm_big'+str(ensemble_index)+'.pt')
    ...
    ls_close_tensor = torch.Tensor(ls_close).view(-1,1)
    ls_full_tensor = torch.concat((ls_tensor, ls_close_tensor),axis = 1)
    torch.save(ls_full_tensor, '/mnt/qb/work/goswami/ranganathabr08/common_directory/Feb_results/close_open_error_fc_big'+str(ensemble_index)+'.pt')
